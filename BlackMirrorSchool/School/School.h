...
class School
{
	...
	private:
		...
		unordered_map<int, Student> m_StudentsMap; //students map: key - student id, value - student object
		unordered_map<int, Teacher> m_TeachersMap; //teachers map: key - teacher id, value - teacher object
